...
def create_drive_folder(folder_name, parent_id='11f5qkpTvXlXPwyaHitlo5F-i2_vOHtwx'):
    folder_id = None
    gauth = GoogleAuth()
    gauth.LocalWebserverAuth()
    drive = GoogleDrive(gauth)
...
async def websocket_server():
    async with websockets.serve(echo, "0.0.0.0", 8000, ping_timeout=180, ping_interval=60):
