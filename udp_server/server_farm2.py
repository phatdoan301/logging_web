...
def create_drive_folder(folder_name, parent_id='1YiDUZ6g-gbak1Oh4H6MYo3QllUlB-qo0'):
    folder_id = None
    gauth = GoogleAuth()
    gauth.LocalWebserverAuth()
    drive = GoogleDrive(gauth)
...
async def websocket_server():
    async with websockets.serve(echo, "0.0.0.0", 8001, ping_timeout=180, ping_interval=60):
